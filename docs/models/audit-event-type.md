...
```typescript
"agent_invocation" | "agent_step" | "model_call" | "tool_call" | "harness_exit" | "invocation_failed" | "invocation_succeeded" | "llm_call" | "tool_result" | "run_failed" | "run_succeeded" | Unrecognized<string>
```