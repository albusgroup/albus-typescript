 ...
 */
export function memoriesDeleteMemoryGroup(
  client: AlbusCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteMemoryGroupRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/memories")();
