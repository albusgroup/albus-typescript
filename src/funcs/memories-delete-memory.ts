 ...
 */
export function memoriesDeleteMemory(
  client: AlbusCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteMemoryRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/memorygroups/{group}/memories/{id}")(pathParams);
