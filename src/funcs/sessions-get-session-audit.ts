...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetSessionAuditRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/sessions/{id}/audit")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListAuditEventsResponse$inboundSchema),
