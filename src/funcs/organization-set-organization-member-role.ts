 ...
 */
export function organizationSetOrganizationMemberRole(
  client: AlbusCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SetOrganizationMemberRoleRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/organization/members/{user_id}/role")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.OrganizationMember$inboundSchema),
