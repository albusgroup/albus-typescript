 ...
 */
export function organizationListOrganizationMembers(
  client: AlbusCore,
  _request?: operations.ListOrganizationMembersRequest | undefined,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListOrganizationMembersResponse$inboundSchema),
